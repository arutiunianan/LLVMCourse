...
check_next_x:
    ...
    RET R5             ; возвращаем количество живых соседей
...
updatePixel:
    ...
    ADD R7, R6, R4            ; %7 = %6 + x
    EXT R8, R7                ; %8 = (i64)%7 (расширяем до 64 бит)
...
process_pixel:
    TRUNC R8, R7 to i32        ; Приведение типа индекса
    CALL simPutPixel, R8, R21, R20 ; Обновление цвета пикселя

    ; Подсчет живых соседей
    CALL countLivingNeighbors ; Получение количества живых соседей
...
inner_loop:
    ...
    ADD R8, R7, R5            ; %8 = %7 + x
    EXT R9, R8                ; %9 = (i64)%8 (расширяем до 64 бит)
